...
from src.graph_data import build_dataset, to_undirected_edge_index
from src.metrics import compute_metrics, select_threshold, summarize_metric_dicts
from src.models import DotDecoder, GraphSAGEEncoder
...
def train_one_seed(args, dataset, output_dir, seed):
    ...
    encoder = GraphSAGEEncoder(x.size(1), hidden_dim=args.hidden_dim, dropout=args.dropout).to(device)
